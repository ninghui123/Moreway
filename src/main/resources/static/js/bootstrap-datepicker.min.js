(function(d,g){
    ...
    var n=(function(){
        var s={
            ...
            copy:function(){var t=new n();
                t.replace(this);return t}};
        return function(){var t=[];
            t.push.apply(t,arguments);
            d.extend(t,s);return t}})();
    var q=function(t,s){
        this.dates=new n();
        this.viewDate=c();
        this.focusDate=null;
        ...
        if(this.component&&this.component.length===0){
            this.component=false}this.picker=d(h.template);
        this._buildEvents();
        this._attachEvents();
        if(this.isInline){
        ...
        if(this.o.calendarWeeks){
            this.picker.find("tfoot th.today").attr("colspan",function(u,v){return parseInt(v)+1})}
    ...
    q.prototype={constructor:q,_process_options:function(s){
        ...
        var v=w.language;if(!f[v]){v=v.split("-")[0];
            if(!f[v]){v=i.language}}w.language=v;switch(w.startView){
            case 2:case"decade":w.startView=2;break;case 1:case"year":w.startView=1;break;
            default:w.startView=0}switch(w.minViewMode){
            case 1:case"months":w.minViewMode=1;break;case 2:case"years":w.minViewMode=2;
                break;default:w.minViewMode=0}w.startView=Math.max(w.startView,w.minViewMode);
        if(w.multidate!==true){w.multidate=Number(w.multidate)||false;if(w.multidate!==false){
            w.multidate=Math.max(0,w.multidate)}
        else{w.multidate=1}}w.multidateSeparator=String(w.multidateSeparator);
        w.weekStart%=7;w.weekEnd=((w.weekStart+6)%7);
        var t=h.parseFormat(w.format);
        if(w.startDate!==-Infinity){
            if(!!w.startDate){
                if(w.startDate instanceof Date){w.startDate=this._local_to_utc(this._zero_time(w.startDate))
                }else{
            ...
            if(!!w.endDate){
                ...
                }else{w.endDate=h.parseDate(w.endDate,t,w.language)}
            }else{w.endDate=Infinity}}w.daysOfWeekDisabled=w.daysOfWeekDisabled||[];
    ...
    var h={modes:[{clsName:"days",navFnc:"Month",navStep:1},
