...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tActionUpload = '<button type="button" class="kv-file-upload {uploadClass}" onclick=upload();  title="{uploadTitle}">' +
                '{uploadIcon}</button>';
    ...
    $.fn.fileinputLocales.en = {
        ...
        msgCancelled: '取消',
        msgPlaceholder: '输入上传文件 ...',
        msgZoomModalHeading: '查看详细信息',
        msgFileRequired: '必须选择要上载的文件',
...
//文件上传
function upload() {
            var fileObj = document.getElementById("file-3").files[0]; // js 获取文件对象
